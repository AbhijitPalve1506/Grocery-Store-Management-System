...
class categoryClass(Frame):
    def __init__(self, root):
        ...
        lbl_name=Label(self.root,text="Enter Category Name",font=("goudy old style",30),fg="white",bg="black").place(x=50,y=100)
        ...
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=500,y=170,width=130,height=30)
        #======Category Details===  
        cat_frame=Frame(self.root,bd=3,relief=RIDGE)
        cat_frame.place(x=700,y=100,width=280,height=100)
        ...
        #=====images======
        self.im1=Image.open("images/Gr.jpg")
        self.im1=self.im1.resize((455,250),Image.LANCZOS)
        self.im1=ImageTk.PhotoImage(self.im1)
        self.lbl_im1=Label(self.root,image=self.im1,bd=2,relief=RAISED)
        self.lbl_im1.place(x=50,y=220) 
        self.im2=Image.open("images/Gimp.jpg")
        self.im2=self.im2.resize((305,250),Image.LANCZOS)
